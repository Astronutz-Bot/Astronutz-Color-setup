...
module.exports = class BlastCommand extends Command {
  constructor(client) {
    super(client, {
      name: 'blast',
      usage: 'blast <message>',
      description: 'Sends a message to every server that bot is in that has a system channel.',
    ...
    message.client.guilds.cache.forEach(guild => {
      ...
      if (
        ...
        const embed = new MessageEmbed()
          .setTitle('Anstronutz System Message')
          .setThumbnail('https://images-ext-2.discordapp.net/external/_JvIbP1I3zlRzRB9Ryoo_PvfjzIOYjU_lJ1bzTzo0i8/%3Fsize%3D1024/https/cdn.discordapp.com/avatars/855055398298058773/e9b9ea033bd027cb2556e6dac712b48a.webp?width=413&height=413')
          .setDescription(msg)
          .setTimestamp()
